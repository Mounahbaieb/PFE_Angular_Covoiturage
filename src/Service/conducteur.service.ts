...
export class ConducteurService {
  ...
  private apiUrl = 'http://23.23.183.159:30008/api/conducteurs/signup';

  private api = 'http://23.23.183.159:30008/api/conducteurs';
...
getConducteurById(id: string): Observable<Conducteur> {
  return this.http.get<Conducteur>(`http://23.23.183.159:30008/api/conducteurs/${id}`);
}
  ...
  editConducteur(data: any, id: string): Observable<any> {
    return this.http.put(`http://23.23.183.159:30008/api/conducteurs/${id}`, data);
  }

  save(form: any): Observable<any> {
    return this.http.post<any>('http://23.23.183.159:30008/api/conducteurs', form);
  }
